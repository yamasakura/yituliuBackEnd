...
public interface StageResultSetInfoService {
    ...
    //添加T3类材料的理智转化率
    void setStageResultPercentageT3(Integer times, Double efficiency);
    //添加T2类材料的理智转化率
    void setStageResultPercentageT2(Integer times, Double expect);
    ...
    //设置历史关卡的理智转化率
    void setClosedActivityStagePercentage(String[] actNameList);
    //添加置信度
